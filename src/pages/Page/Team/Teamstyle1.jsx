    ...
    <Layout>
      ...
      <div className='grid lg:grid-cols-3 grid-cols-1 p-[2rem] gap-[2rem]'>
        <div>
            ...
            <img src='https://preetheme.com/html/bhouse/assets/img/team/1.jpg' alt='' className='w-[70%] rounded-[50%]' />
            </div>
            <div className='text-center p-2'>
              <h1 className='text-xl font-bold'>A.H John Doe</h1>
              <p>Designer</p>
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-center">
            <img src='https://preetheme.com/html/bhouse/assets/img/team/2.jpg' alt='' className='w-[70%] rounded-[50%]' />
            </div>
            <div className='text-center p-2'>
              <h1 className='text-xl font-bold'>A.H John Doe</h1>
              <p>Designer</p>
          ...
          <div>
            <div className="flex justify-center">
            <img src='https://preetheme.com/html/bhouse/assets/img/team/3.jpg' alt='' className='w-[70%] rounded-[50%]' />
            </div>
            <div className='text-center p-2'>
              <h1 className='text-xl font-bold'>A.H John Doe</h1>
              <p>Designer</p>
          ...
          <div>
            <div className="flex justify-center">
            <img src='https://preetheme.com/html/bhouse/assets/img/team/4.jpg' alt='' className='w-[70%] rounded-[50%]' />
            </div>
            <div className='text-center p-2'>
              <h1 className='text-xl font-bold'>A.H John Doe</h1>
              <p>Designer</p>
          ...
          <div>
            <div className="flex justify-center">
            <img src='https://preetheme.com/html/bhouse/assets/img/team/5.jpg' alt='' className='w-[70%] rounded-[50%]' />
            </div>
            <div className='text-center p-2'>
              <h1 className='text-xl font-bold'>A.H John Doe</h1>
              <p>Designer</p>
          ...
          <div>
            <div className="flex justify-center">
            <img src='https://preetheme.com/html/bhouse/assets/img/team/6.jpg' alt='' className='w-[70%] rounded-[50%]' />
            </div>
            <div className='text-center p-2'>
              <h1 className='text-xl font-bold'>A.H John Doe</h1>
              <p>Designer</p>
