  ...
  return (
    <div className="md:px-[2rem] lg:py-20">
      <div className="flex flex-col items-center justify-center mb-10">
        ...
        <h1 className="lg:text-4xl text-2xl font-black text-[#0B2B3C] ">
          Building Aminities
        </h1>
      </div>
      <div className="flex flex-row lg:flex-col gap-4 lg:gap-0 justify-center">
      <div className="grid grid-cols-1 md:grid-cols-5 gap-7 pb-10">
        <div className="shadow-[1px_0px_5px_0px_rgba(0,0,0,0.1)] rounded flex flex-col items-center justify-center px-5 py-8">
          <IoHomeOutline className="h-10 w-12 text-[#5f3afc]" />
          <h1 className="font-bold text-xs p-2">Residential</h1>
        ...
        <div className="shadow-[1px_0px_5px_0px_rgba(0,0,0,0.1)] rounded flex flex-col items-center justify-center px-5 py-8">
          ...
          <h1 className="font-bold text-xs p-2">Parking Space</h1>
          <span className="h-8 w-8 flex items-center justify-center bg-gray-300 rounded-full p-1">
            22
          </span>
        </div>
        <div className="shadow-[1px_0px_5px_0px_rgba(0,0,0,0.1)] rounded flex flex-col items-center justify-center px-5 py-8">
          ...
          <h1 className="font-bold text-xs p-2">Commercial</h1>
          <span className="h-8 w-8 flex items-center justify-center bg-gray-300 rounded-full p-1">
            15
          </span>
        </div>
        <div className="shadow-[1px_0px_5px_0px_rgba(0,0,0,0.1)] rounded flex flex-col items-center justify-center px-5 py-8">
          ...
          <h1 className="font-bold text-xs p-2">Appartment</h1>
          <span className="h-8 w-8 flex items-center justify-center bg-gray-300 rounded-full p-1">
            19
          </span>
        </div>
        <div className="shadow-[1px_0px_5px_0px_rgba(0,0,0,0.1)] rounded flex flex-col items-center justify-center px-5 py-8">
          ...
          <h1 className="font-bold text-xs p-2">Industrial</h1>
          <span className="h-8 w-8 flex items-center justify-center bg-gray-300 rounded-full p-1">
            10
          </span>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-7 pb-10">
        <div className="shadow-[1px_0px_5px_0px_rgba(0,0,0,0.1)] rounded flex flex-col items-center justify-center px-5 py-8">
          ...
          <h1 className="font-bold text-xs p-2">Building Code</h1>
          <span className="h-8 w-8 flex items-center justify-center bg-gray-300 rounded-full p-1">
            15
          </span>
        </div>
        <div className="shadow-[1px_0px_5px_0px_rgba(0,0,0,0.1)] rounded flex flex-col items-center justify-center px-5 py-8">
          ...
          <h1 className="font-bold text-xs p-2">Swimming Pool</h1>
          <span className="h-8 w-8 flex items-center justify-center bg-gray-300 rounded-full p-1">
            12
          </span>
        </div>
        <div className="shadow-[1px_0px_5px_0px_rgba(0,0,0,0.1)] rounded flex flex-col items-center justify-center px-5 py-8">
          ...
          <h1 className="font-bold text-xs p-2">Private Security</h1>
          <span className="h-8 w-8 flex items-center justify-center bg-gray-300 rounded-full p-1">
            12
          </span>
        </div>
        <div className="shadow-[1px_0px_5px_0px_rgba(0,0,0,0.1)] rounded flex flex-col items-center justify-center px-5 py-8">
          ...
          <h1 className="font-bold text-xs p-2">Smart Homes</h1>
          <span className="h-8 w-8 flex items-center justify-center bg-gray-300 rounded-full p-1">
            12
          </span>
        </div>
        <div className="shadow-[1px_0px_5px_0px_rgba(0,0,0,0.1)] rounded flex flex-col items-center justify-center px-5 py-8">
          <IoHomeOutline className="h-10 w-12 text-[#5f3afc]" />
          <h1 className="font-bold text-xs p-2">Resdential</h1>
          <span className="h-8 w-8 flex items-center justify-center bg-gray-300 rounded-full p-1">
            12
          </span>
        </div>
